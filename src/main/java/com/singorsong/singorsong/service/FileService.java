...
public class FileService {
    ...
    public LinkedHashMap playAudio() throws Exception{

        //파일을 파일객체에 넣는다/
        File file = new File("/Users/kmh/IdeaProjects/SingOrSong/frontend/src/assets/mp3/chasing-horizons-228832.mp3");
